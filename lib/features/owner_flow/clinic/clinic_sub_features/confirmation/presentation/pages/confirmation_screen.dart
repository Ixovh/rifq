          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                Text(
                  "Your Appointment Is Confirmed", textAlign: TextAlign.center, style:TextStyle(color: context.primary300, fontSize: 24.sp, fontWeight: FontWeight.w500
                ),
                ),
                 SizedBox(height: 20),
                //TODO: IMAGE
                Image.asset('assets/images/confirmed 1.png', height: 220),
                 SizedBox(height: 14),
                Text(
                  ...
                  child: Row(
                    children: [
                      Image.asset('assets/images/calendar.png'),
                       SizedBox(width: 10),
                      Text("Appointment Details", style: context.body1.copyWith(color: context.neutral800)),
                    ],
                  ),
                ),
