...
class EditPetProfileCubit extends Cubit<EditPetProfileState> {
    ...
    try {
      ...
      result.when(
          ...
          final updatedPet = PetProfileEntity(
            ...
            photoUrl: data['photo'] ?? updatedPhoto, // استخدم updatedPhoto ك fallback
            breed: pet.breed,
            species: pet.species,
  ...
  //     if (pickedFile == null) return null;// المستخدم ما اختار صورة
  //
  //     final file = File(pickedFile.path);
  //     final fileName = 'pets/${pet.id}_${DateTime
